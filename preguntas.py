...
st.radio("¿Su objetivo principal de inversión es a ?", [None, "Corto plazo (1-3 años)", "Mediano plazo (3-5 años)" , "Largo plazo (más de 5 años)"])

st.radio("¿Qué nivel de riesgo estás dispuesto a asumir en sus inversiones?", [None, "Bajo", "Moderado", "Alto"])
