...
st.text_area("Invertir en un fondo", "Solo tienes que elegir el o los Fondos que te más te interesen"
            "De acuerd a tu elección irás recibiendo rendimientos, que son resultado de la rentabilidad"
...
st.text_area("Banorte brinda", "Crecimiento", "Experiencia", "Diversificación", "Flexibilidad")
